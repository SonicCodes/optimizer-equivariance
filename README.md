...
The hessian tells us how the loss landscape is affected by moving in any direction on it, almost like curvature/evolution, thus a diagonal hessian would be like, "imagine a loss landscape with 3 dimensions, moving in dimension 1 should not affect dimension 2 or 3".  Its impractical for neural networks to have a diagonal hessian as it would mean each parameter has its own loss component, but ...
